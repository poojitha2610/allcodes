 ...
 static long totalbill;
  ...
  {  
    ...
    switch (c)
      {
      case 1:
          System.out.println("minimum balance to purchase in this section is 600");
	int e_q1 = 15;
	int e_q2 = 10;
	int e_q3 = 11;
	int e_c1 = 40000;
...
//	           System.out.println("insufficient funds"+":"+fixedbudget);break;}}
	  ...
	  {if(fixedbudget>=b_c3){
	    ...
	    System.out.println("remaining balance="+" "+(fixedbudget));
	           ...
	           System.out.println("insufficient funds"+":"+fixedbudget);
	           }
	  }
//    long b_bill=(b_cost1+b_cost2+b_cost3);
//	  System.out.println("total bill in bathroom="+b_bill);
   break;
      case 3:
    ...
    long k_bill=(k_cost1+k_cost2+k_cost3);
	  System.out.println("total bill in kitchen="+k_bill);}
	break;
      case 4:
	...
	if (c_id == 1)
	  ...
	  { if(fixedbudget>=c_c3){
	    ...
	    System.out.println("remaining balance="+" "+(fixedbudget));
	           ...
	           System.out.println("insufficient funds"+":"+fixedbudget);break;}}
      long c_bill=(c_cost1+c_cost2+c_cost3);
	  System.out.println("total bill in clothes="+c_bill);}
	 	break;
